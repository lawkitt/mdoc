...
The complete public API of [`mdoc-editor`](README.md) — every exported item,
...
crate root; nothing from `mdoc-markdown` is re-exported.)
...
(typically with [`mdoc-markdown`](../mdoc-markdown), whose
...
**Host obligation:** none. mdoc anchors a hover preview card to the box.
