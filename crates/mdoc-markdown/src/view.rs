...
pub struct MarkdownStyle {
    ...
    /// match it to the editor's ratio so reading and editing line up (mdoc
    /// passes mdoc-editor's 1.45); the default follows suit.
    pub line_height: f32,
...
impl MarkdownView {
    ...
    /// mdoc-markdown only paints: no I/O, no storage, just the source string.
