...
A reference document exercising everything `mdoc-markdown` renders. Use it with
a host application to inspect the renderer, or read it as living documentation
of supported syntax.
...
- Wiki-link (mdoc): [[project]]
- Tags (mdoc): #markdown #test-page
